...
- Name: Protected Area Functionality >> SCN_PROT_002: should delete a flashcard set
- Location: D:\done\fiszki_v2\e2e\protected.spec.ts:119:7
...
Locator: locator('[data-testid*="set-row-"]').filter({ hasText: 'Delete Test Set 1749974386748' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 15000ms
  - waiting for locator('[data-testid*="set-row-"]').filter({ hasText: 'Delete Test Set 1749974386748' })

    at createSet (D:\done\fiszki_v2\e2e\protected.spec.ts:82:7)
    at D:\done\fiszki_v2\e2e\protected.spec.ts:122:19
```
      ...
      - rowgroup:
        ...
        - row "Updated Set 1749973809386 Ja pending 0 15 czerwca 2025":
          ...
          - cell:
            ...
            - button:
              - img
        - row "Test Set 1749974386776 Ja pending 0 15 czerwca 2025":
          - cell "Test Set 1749974386776"
          - cell "Ja"
          - cell "pending"
          - cell "0"
          - cell "15 czerwca 2025"
...
```ts
   ...
   2 |
   3 | const E2E_EMAIL = process.env.E2E_EMAIL || "test@test.pl";
   4 | const E2E_PASSWORD = process.env.E2E_PASSWORD || "Test123!";
   5 | const E2E_USERNAME = process.env.E2E_USERNAME || "test";
   6 |
   7 | test.describe("Protected Area Functionality", () => {
   8 |   // Log in before each test in this describe block
   9 |   test.beforeEach(async ({ page }) => {
   10 |     await page.goto("/sign-in");
   11 |
   12 |     const navigationPromise = page.waitForURL("**/protected", {
   13 |       timeout: 15000,
   14 |     });
   15 |
