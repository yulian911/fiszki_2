...
export default function FlashcardsSetsListViewPage() {
  ...
  const handleUpdateFilters = useCallback((newFilters: Partial<typeof filters>) => {
      ...
      return (
        <div className="flex items-center justify-center py-12">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-center text-sm text-muted-foreground">Ładowanie zestawów...</p>
          </div>
        </div>
      );
    }
      ...
      return (
        <div className="text-center py-10">
          <p className="text-destructive mb-4">
            Wystąpił błąd podczas ładowania zestawów: {error instanceof Error ? error.message : 'Unknown error'}
          </p>
  ...
  }, [isLoading, isError, error, setsData, isFetching, refetch, handleViewDetails, open, filters, resetFilters]);
