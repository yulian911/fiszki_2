...
export const createFlashcardsSetCommandSchema = z.object({
  name: z.string().min(3, "Nazwa musi mieć co najmniej 3 znaki").max(100, "Nazwa nie może być dłuższa niż 100 znaków"),
  description: z.string().max(500, "Opis nie może być dłuższy niż 500 znaków").optional(),
});

export const updateFlashcardsSetCommandSchema = z.object({
